        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <button onclick="excel()" class="btn-primary">导出账单</button>
...
<script type="text/javascript">
    ...
    function btnGroup () {   // 自定义方法，添加操作按钮 data-target="xxx" 为点击按钮弹出指定名字的模态框
        var html =
            '<a href="####" class="btn btn-sm btn-danger" id="pay" data-toggle="modal" data-target="#pay" title="参加活动">' +
            '<span>缴费</span></a>&nbsp;'
        return html
    };
    function excel() {
        location.href="/bill/exportExcel?teamId=${teamId}"
    }
    function pay(id) {
        layer.open({
            type: 2,
            ...
            area : ['800px' , '600px'],
            content:'/bill/toPay?billId='+id//弹框显示的url,对应的页面
        });
    }
</script>
</body>
